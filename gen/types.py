...
class AffinityKey(TypedDict, total=False):
    app_id: str
    version_id: str
    setup: str
...
class RemoteEngineCreateRequest(TypedDict, total=False):
    name: str
    instance_type: Optional[RemoteEngineInstanceTypeRef]
    start_time: str
    end_time: str

class EngineRegisterRequest(TypedDict, total=False):
    local_engine_state: Optional[LocalEngineState]
    api_url: str
...
class HandleSlackEventRequest(TypedDict, total=False):
    ...
    # App Rate Limiting
    minute_rate_limited: Optional[int]
...
class CELEvalRequest(TypedDict, total=False):
    pricing: Optional[AppPricing]
    output_meta: Optional[OutputMeta]
...
class AppStoreVersionDTO(TypedDict, total=False):
    ...
    pricing: Optional[AppPricing]
    draft_pricing: Optional[AppPricing]
...
class EvaluateDraftPricingRequest(TypedDict, total=False):
    ...
    task_inputs: Dict[str, Any]
    pricing_override: Optional[AppPricing]
...
class PublishDraftPricingResponse(TypedDict, total=False):
    pricing: Optional[AppPricing]
    previous_pricing: Optional[AppPricing]
...
class AppStoreVersionSubmitRequest(TypedDict, total=False):
    license: str
    license_mandatory: Optional[bool]
    allows_commercial: Optional[bool]
    pricing: Optional[AppPricing]
...
class BillingSettingsUpdateRequest(TypedDict, total=False):
    spending_limit: Optional[int]
    low_balance_threshold: Optional[int]
    auto_recharge_enabled: Optional[bool]
    auto_recharge_amount: Optional[int]
    auto_recharge_threshold: Optional[int]
    billing_email: Optional[str]
    low_balance_alerts: Optional[bool]
    usage_summary_enabled: Optional[bool]
    usage_summary_interval: Optional[str]
    company_name: Optional[str]
    tax_id: Optional[str]
    is_business_customer: Optional[bool]
...
class LinearIssue(TypedDict, total=False):
    ...
    state: Optional[LinearWorkflowState]
    labels: List[LinearLabel]
    assignee: Optional[LinearUser]
    created_at: str
    updated_at: str
...
class CreateCommentResponse(TypedDict, total=False):
    comment: Optional[LinearCommentDTO]
...
class ResourceRequest(TypedDict, total=False):
    ...
    userId: str
    resource: Any
    listOptions: Optional[ListRequest]
...
class MCPServerCreateResponse(TypedDict, total=False):
    discovery: Optional[MCPServerDiscovery]
...
class PublicationTheme(TypedDict, total=False):
    ...
    dark: Optional[PublicationThemeColors]
...
class TimescaleTaskDTO(TypedDict, total=False):
    id: str
    timestamp: str
    task_id: Optional[str]
    task_seq: int
...
class ResourcePriceDTO(BaseModelDTO, TypedDict, total=False):
    name: str
    cents_per_hour: int
    microcents_per_second: int
    notes: str
...
class TeamPlanDTO(BaseModelDTO, TypedDict, total=False):
    team_id: str
    plan_id: str
...
class BillingDTO(BaseModelDTO, PermissionModelDTO, TypedDict, total=False):
    balance: int
    currency: str
    status: BillingStatus

# BillingSettingsDTO is the data transfer object for BillingSettings
class BillingSettingsDTO(BaseModelDTO, PermissionModelDTO, TypedDict, total=False):
    spending_limit: int
    low_balance_threshold: int
    auto_recharge_enabled: bool
    auto_recharge_amount: int
    auto_recharge_threshold: int
    auto_recharge_last_failed_at: Optional[str]
...
class CreditGrantDTO(BaseModelDTO, PermissionModelDTO, TypedDict, total=False):
    type: CreditGrantType
    notes: str
    amount: int
    expires_at: Optional[str]
    status: CreditGrantStatus
    payment_record_id: Optional[str]
    remaining: int
...
class InvoiceDTO(BaseModelDTO, PermissionModelDTO, TypedDict, total=False):
    type: InvoiceType
    invoice_number: str
...
class PaymentRecordDTO(BaseModelDTO, PermissionModelDTO, TypedDict, total=False):
    type: PaymentRecordType
...
class PublicationDTO(BaseModelDTO, PermissionModelDTO, TypedDict, total=False):
    resource_type: str
    resource_id: str
    namespace: str
    name: str
    ...
    theme: Optional[PublicationTheme]
    label: str
    enabled: bool
...
class TaskStreamDTO(BaseModelDTO, PermissionModelDTO, TypedDict, total=False):
    status: TaskStatus
    app_id: str
    app_version_id: str
    app_variant: str
...
class TransactionDTO(BaseModelDTO, PermissionModelDTO, TypedDict, total=False):
    type: TransactionType
    amount: int
    reference: str
    notes: str
    payment_record_id: Optional[str]
    usage_billing_record_id: Optional[str]
...
IntegrationProviderGoogle = "google"
IntegrationProviderSlack = "slack"
IntegrationProviderNotion = "notion"
IntegrationProviderGitHub = "github"
IntegrationProviderX = "x"
IntegrationProviderMicrosoft = "microsoft"
IntegrationProviderSalesforce = "salesforce"
IntegrationProviderDiscord = "discord"
IntegrationProviderGCP = "gcp"
IntegrationProviderMCP = "mcp"
